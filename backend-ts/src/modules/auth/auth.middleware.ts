...
export const authenticate = (authService: AuthService, users: UserRepository): RequestHandler => {
...
export const optionalAuth = (authService: AuthService, users: UserRepository): RequestHandler => {
